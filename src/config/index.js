...
export const STATUS_CONFIG = {
  ...
  process: {
    label: 'Selesai',
    color: 'bg-emerald-900/35 text-emerald-200 border-emerald-500/25'
  },
  completed: {
    label: 'Tutup',
...
/**
 * Shift separation constraints
 * Pairs of employees that must NOT be in the same shift
 * Easy to modify - just add/remove pairs
 * 
 * Format: Array of [name1, name2] pairs
 * Example: [['Robert', 'Ariel']] means Robert & Ariel never in same shift
 */
export const SHIFT_CONSTRAINTS = {
  separatedPairs: [
    ['Robert', 'Ariel']  // ← Mudah diubah: ganti nama atau tambah pair baru
  ]
};
